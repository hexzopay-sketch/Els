    ...
    <div className="space-y-6">
      ...
      >
        ...
        >
          ...
          <Checkbox checked={premium} onChange={() => setPremium(!premium)} label="Premium" />
          <Checkbox checked={apiAccess} onChange={() => setApiAccess(!apiAccess)} label="API Access" />
        ...
        <table className="w-full text-sm text-left text-text-muted border border-border rounded-lg">
          ...
          <tbody>
            ...
            {plans.map((plan) => (
              <tr
                key={plan.name}
                className="border-b border-border hover:bg-subtle"
              >
